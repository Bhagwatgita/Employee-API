...
*/
alter proc [dbo].[proc_EmployeeOperation]
	 @flag			CHAR(5)	
		...
		IF @flag = 'i'
			BEGIN
				...
				FROM dbo.Employee(NOLOCK) emp
					...
					--SELECT 0 errorCode, 'New Employee has been added successfully.' mes, @Id paramKey
					Return	
			END
		ELSE IF @flag = 'd'
			BEGIN
				...
				COMMIT TRANSACTION
				SELECT 0 ErrorCode, 'Employee successfully deleted.' mes, @Id paramKey	
				Return
			END
		ELSE IF @flag = 'u'
				BEGIN
